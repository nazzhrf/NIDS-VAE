...
patator_data = readmatrix("C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\a3_patator.csv");
...
figure(1);
hold on;
plot(a2(1,1:1000), zeros(1,1000), 'or'); % B samples
plot(a2(1,1001:2000), zeros(1,1000), 'xk'); % NB samples
hold off;
xlabel('y_1 = a^2_1');
...
file_path = "C:\\EL\\VLSI\\VAE_NEW_ISICAS_20-03-2025\\MATLAB_LSI_CONTEST\\Modified_4type\\wb_training\\ae_wb_patator.txt";
