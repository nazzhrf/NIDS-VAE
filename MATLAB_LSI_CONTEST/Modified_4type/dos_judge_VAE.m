...
b_data = readmatrix("C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\train_benign_for_dos.csv");
dos_data = readmatrix("C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\train_dos.csv");

% Remove header row
b_data = b_data(2:end, :);
dos_data = dos_data(2:end, :);

% Select first 500 rows
b_data = b_data(1:1000, :)'; % Transpose to match expected format
dos_data = dos_data(1:1000, :)';
...
a3_out = "C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\a3_dos.csv" ;
...
file_path = "C:\\EL\\VLSI\\VAE_NEW_ISICAS_20-03-2025\\MATLAB_LSI_CONTEST\\Modified_4type\\wb_training\\input_buffer_dos.txt";
