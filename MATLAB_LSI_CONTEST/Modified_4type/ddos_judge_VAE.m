...
b_data = readmatrix("C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\train_benign_for_ddos.csv");
ddos_data = readmatrix("C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\train_ddos.csv");

% Remove header row
b_data = b_data(2:end, :);
ddos_data = ddos_data(2:end, :);

% Select first 500 rows
b_data = b_data(1:2000, :)'; % Transpose to match expected format
ddos_data = ddos_data(1:2000, :)';
...
figure(1);
hold on;
plot(a2(1,1:2000), a2(2,1:2000), 'or'); % B samples
plot(a2(1,2001:4000), a2(2,2001:4000), 'xk'); % NB samples
hold off;
...
a3_out = "C:\\EL\\TKTE_PTE\\VAE_Dataset\\4type\\a3_ddos.csv" ;
...
%% KONVERSI WEIGHT DAN BIAS DALAM DESIMAL KE FIXED POINT Q.5.10
...
file_path = "C:\\EL\\VLSI\\VAE_NEW_ISICAS_20-03-2025\\MATLAB_LSI_CONTEST\\Modified_4type\\wb_training\\input_buffer_ddos.txt";
